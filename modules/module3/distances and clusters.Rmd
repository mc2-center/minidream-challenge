...
### Part 1: Create a 2x2 matrix such that row 1 contains 2 and 4, and row 2 contains 100 and 200.
...
my_dist_eucl <- dist(mat2, method = "xxxxxxx")
...
In the code chunk above, run k-means for 3 clusters. In other words, set `km_2` to 3.
