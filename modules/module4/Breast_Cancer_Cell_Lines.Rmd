...
Most of the columns don’t add up to a million, but the sums are close! The original data table included many more rows than the 18,682 we see here, but in preprocessing the data, the genes that do not code for proteins were removed.
...
The **Gene Ontology (GO)** knowledgebase is the world’s largest source of information on the functions of genes. Genes are annotated with biological functions (GO terms) by experts.
