...
ChickWeight is a dataset that contains the weight of chicks on different diets over the first 21 days of their lives. Lets install and import `ggplot2` so we can use it to visualize our dataset.
```{r}
